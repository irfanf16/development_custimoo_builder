...
export default {
  ...
  mounted: async function() {
    ...
    if(!ele) {
      ...
      const elementById = getWindowObject().document.getElementById('3d7b2a19-8d69-47ee-af45-fbcc339e9868')
      if(elementById) {
        ele = elementById.querySelector('[data-ux="Container"]')
        const widget = elementById.querySelector('[data-ux="Widget"]')
        if(widget) {
