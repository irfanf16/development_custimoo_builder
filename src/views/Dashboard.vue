<template>
  <div class="page-wrapper m-lg-4">
    ...
    <div v-else class="container-fluid bg-white h-100 p-3">
      <!--      <div class="text-left">-->
                ...
                <router-link :to="'customer-orders'" class="my-orders">
                  <div class="row no-gutters">
                    <div class="col-md-4 d-flex align-items-center justify-content-center border-right">
                      <i class="fa-solid fa-shirt" style="font-size: 2rem"></i>
                    </div>
                    <div class="col-md-8">
                      <div class="card-body">
                        <h5 class="card-title h3">{{ counters ? counters.orders_count : 0 }}</h5>
                        <p class="card-text h4">My Orders</p>
                      </div>
                    </div>
                  </div>
                </router-link>
            ...
            <div class="col-12 col-lg-4">
              <div class="card mb-3 bg-primary text-white" style="max-width: 540px;">
                <router-link :to="'customer-orders?filter=submitted_for_customer_review'" class="my-orders">
                  <div class="row no-gutters">
                    <div class="col-md-4 d-flex align-items-center justify-content-center border-right">
                      <i class="fa-solid fa-file-image" style="font-size: 2rem"></i>
                    </div>
                    <div class="col-md-8">
                      <div class="card-body">
                        <h5 class="card-title h3">{{ counters ? counters.pending_approval_count : 0 }}</h5>
                        <p class="card-text h4">Pending Approvals</p>
                      </div>
                    </div>
                  </div>
                </router-link>
              ...
              <div class="card mb-3 bg-danger text-white" style="max-width: 540px;">
                <router-link :to="'customer-orders?filter=shipped'" class="my-orders">
                  <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                        <h5 class="card-title h3">{{ counters ? counters.track_my_orders_count : 0 }}</h5>
                        <p class="card-text h4">Track my orders</p>
                      </div>
                    </div>
                  </div>
                </router-link>
