...
import {getLogoSettingsObject, getProductColors, setLogoSettings} from "@/helpers/Helpers";
import UploadLogo from "@/components/UploadLogo.vue"
import UploadLogoMobile from "@/components/mobile/LogoUploaderMobile_back.vue"
...
import LogoUploaderMobile from "@/components/mobile/LogoUploaderMobile_back.vue";
import Vue from "vue";

@Component<LogoPlacementMobile_back>({
  components: {
    LogoUploaderMobile,
    RecentLogos,
    UploadLogo,
