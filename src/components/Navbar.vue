<template>
    <ul class="d-flex gap-3 main-nav">
      ...
      <li v-if="isCustomerAuthenticated && !onlyCompanyOrderTab() && (company.platform !== 'self' ||
       (company.platform == 'self' && company.id !== 1) || 
      ...
      <li v-if="isCustomerAuthenticated && !onlyCompanyOrderTab()">
...
import { onlyCompanyOrderTab } from '../helpers/Helpers'
export default {
    name: 'Navbar',
    mixins:[ModalAction],
    components: {},
