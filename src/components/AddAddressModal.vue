<template>
  <modal  :width="1000"
    ...
    <div class="modal-body">
      <div class="form-holder theme-scroll-v" style="overflow: hidden; overflow-y: auto;" :class="{active: isActive}">
        <div class="form-area add-address p-4">
          <b-form>
            <div class="grid grid-mobile-2 gap-x-3 gap-y-1">
              <b-form-group
                label="First Name *"
            ...
            <div class="grid grid-2 gap-x-3 gap-y-1">
              <b-form-group
                label="Address *"
                label-for="input-1" class="text-left"
              >
