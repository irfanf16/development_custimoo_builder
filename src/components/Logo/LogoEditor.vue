...
export default class LogoEditor extends Mixins(ErrorMessages, ModalAction, CustomLogosMixin) {
  ...
  * */
  ...
  public useLogo() {
    ...
    http.post('/customer/update/logo', data).then(async resp => {
      const logo_data = resp.data.customer_logo
