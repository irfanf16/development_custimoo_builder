<template>
<div>
  <hooper ref="carousel" :settings="{itemsToShow: 4,itemsToSlide: 4}" @slide="loadMoreProduct">
...
export default {
  name: 'items-carousel',
  components: { Scene, Hooper, Slide, HooperNavigation },
  // components: { Scene, Hooper, Slide },
  data: function () {
    return {
