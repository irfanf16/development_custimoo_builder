...
<!--      <span class="close" @click="this.hideAll"><BIconX /></span>-->
      ...
      <div class="d-flex mt-2 flex-column h-100">
        <div class="d-flex align-items-center justify-content-between fs-2 font-weight-bold">
          ...
          <span class="addPlayer" @click="shareRoster"><span class="fs-2 icon position-absolute"><BIconShare /></span> <span class="d-inline-block ml-1">Share {{company.login_code.hasOwnProperty('roster_name')? company.login_code.roster_name : 'Roster' | TitleCase}} Link</span></span>
        </div>
